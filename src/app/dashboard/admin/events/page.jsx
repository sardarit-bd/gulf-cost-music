                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center space-x-2 mt-2">
                                    ...
                                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${event.isActive
...
const EventRow = ({ event, onToggleStatus, onDeleteEvent }) => {
    ...
    const handleEditClick = () => {
        ...
        toast.success(`Edit functionality for "${event.artistBandName}" would open here`);
    };
    ...
    return (
        <>
            <tr className="hover:bg-gray-50 transition-colors group">
                ...
                <td className="px-6 py-4">
                    <button
                        onClick={() => onToggleStatus(event._id, event.isActive, event.artistBandName)}
                    ...
                    >
                        <div className={`w-2 h-2 rounded-full mr-2 ${event.isActive ? "bg-green-500" : "bg-red-500"}`}></div>
                        {event.isActive ? "Active" : "Inactive"}
                    </button>
                </td>
...
const AdminEventsPage = () => {
    ...
    const fetchEvents = async () => {
        try {
            ...
            const res = await axios.get(`${API_BASE}/api/events/admin/events?${params.toString()}`, {
                headers: {
