...
export default function ArtistDashboard() {
  ...
  // useRef ব্যবহার করে audio elements store করা
  ...
  // Handle audio playback - useCallback দিয়ে optimize করা
  ...
  // Handle audio element refs - useCallback দিয়ে optimize করা
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-lg font-medium">{artist.name || "Not set"}</p>
                </div>
                <div>
                  <h4 className="text-sm text-gray-400">City</h4>
                  <p className="text-lg font-medium">{artist.city || "Not set"}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    {artist.biography || "No biography added yet."}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="flex items-center gap-2 text-sm text-gray-400 mb-2">
                    <ImageIcon size={16} /> Photos ({previewImages.length})
                  </h4>
                ...
                <div>
                  <h4 className="flex items-center gap-2 text-sm text-gray-400 mb-2">
                    <Music2 size={16} /> Audio Tracks ({audioPreview.length})
                  </h4>
                  {audioPreview.length > 0 ? (
                    <div className="space-y-3">
                      {audioPreview.map((audio, index) => (
                        <div key={index} className="flex items-center gap-3 p-3 border border-gray-700 rounded-lg bg-gray-800/50">
                          <button
                            onClick={() => toggleAudio(index)}
                            className="flex items-center justify-center w-8 h-8 bg-yellow-500 text-black rounded-full hover:bg-yellow-400 transition-colors"
                          >
