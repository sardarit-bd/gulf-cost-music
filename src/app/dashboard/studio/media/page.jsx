        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30 p-6 md:p-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden md:flex items-center gap-6">
                            ...
                            <div className="text-center">
                                <p className="text-2xl font-bold text-gray-900">{audioFile ? 1 : 0}</p>
                                <p className="text-xs text-gray-600">Audio Samples</p>
                            </div>
                            <div className="text-center">
                                <p className="text-2xl font-bold text-gray-900">{maxPhotos - photoCount}</p>
            ...
            <div className="mb-8">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm font-medium text-gray-900">{photoCount}/{maxPhotos} Photos</span>
                </div>
                        ...
                        !audioFile ? (
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                                    <h3 className="text-lg font-bold text-gray-900 mb-4">Audio Information</h3>
                    ...
                    <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="font-bold">{audioFile ? "✓ Uploaded" : "Not added"}</span>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-sm text-gray-600">Upload high-quality, well-lit photos of your studio</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="w-6 h-6 bg-green-100 text-green-600 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <Music className="w-3 h-3" />
                                </div>
                                <span className="text-sm text-gray-600">Choose your best work for audio samples</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="w-6 h-6 bg-purple-100 text-purple-600 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <Eye className="w-3 h-3" />
                                </div>
                                <span className="text-sm text-gray-600">Profiles with media get 3x more views</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <DeleteModal
                ...
                title={
                    deleteModal.type === "photo" ? "Delete Photo?" :
                        deleteModal.type === "audio" ? "Delete Audio Sample?" :
