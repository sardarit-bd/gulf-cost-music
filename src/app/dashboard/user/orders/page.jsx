...
export default function UserOrderTracking() {
    ...
    const statuses = [
        ...
        { value: "processing", label: "Processing", icon: RefreshCw, color: "text-indigo-600" },
        { value: "ready-for-pickup", label: "Ready for Pickup", icon: Package, color: "text-purple-600" },
                                ...
                                >
                                    ...
                                    <div className="flex gap-4 items-center mb-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-500">{order.quantity} × ${order.merch?.price}</p>
                                    ...
                                    <div className="relative mt-6">
                                        <div className="flex justify-between mb-3">
                                            {statuses.slice(0, 6).map((item, i) => {
                                                ...
                                                return (
                                                    <div key={item.value} className="flex flex-col items-center w-full text-center">
                                                        <div
                                                        ...
                                                        <p className={`text-xs mt-2 ${active ? "text-gray-900" : "text-gray-400"}`}>
                                                            {item.label}
                                                        </p>
                                                    </div>
                                                );
                                    ...
                                    {order.deliveryStatus === "cancelled" && (
                                        <div className="mt-4 p-4 rounded-xl bg-rose-50 border border-rose-200 flex gap-3 items-center">
                                            ...
                                            <p className="text-rose-700 font-medium">This order has been cancelled.</p>
                                        </div>
                                    )}
                                </div>
                            );
