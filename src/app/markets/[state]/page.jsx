      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-pulse mb-6">
            <div
              className={`w-24 h-24 mx-auto bg-gradient-to-r ${stateInfo.color}/20 rounded-full flex items-center justify-center`}
            >
              <ShoppingBag
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 pt-[97px]">
      ...
      <div className="relative overflow-hidden">
        <div
          className={`absolute inset-0 bg-gradient-to-r ${stateInfo.color}/10 via-transparent to-transparent`}
        ></div>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-center">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div
                    className={`w-10 h-10 rounded-xl bg-gradient-to-r ${stateInfo.color} p-3 shadow-lg`}
                  >
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  <div className="relative group">
                    <Search
                      className="absolute left-4 top-1/2 transform -translate-y-1/2 text-yellow-400 group-hover:text-yellow-300 transition-colors"
                      size={20}
                    />
                    <input
                      type="text"
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                {sellerTypes.map((type) => (
                  <button
                    ...
                    className={`group relative overflow-hidden rounded-xl px-4 py-3 transition-all duration-300 transform hover:-translate-y-1 min-w-[100px] ${
                  ...
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${type.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300 ${selectedType === type.id ? "opacity-20" : ""}`}
                    ></div>
                    <div className="relative z-10">
                      <div className="flex flex-col items-center gap-2">
                        <div
                          className={`p-2 rounded-lg ${selectedType === type.id ? "bg-white" : "bg-white/10"}`}
                        >
                          <type.icon
                            size={16}
                            className={
                        ...
                        <span
                          className={`text-xs sm:text-sm font-medium ${selectedType === type.id ? "text-white" : "text-gray-300"}`}
                        >
                          {type.label}
                        </span>
                      </div>
          ...
          <div className="text-center py-20 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-lg rounded-3xl border border-white/10 shadow-2xl">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-300 mb-8">
                We couldn't find any items in {stateInfo.name} matching your
                criteria.
              </p>
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-yellow-400">
                    {selectedType === "all"
                      ? "All Types"
                      : sellerTypes.find((t) => t.id === selectedType)?.label}
                  </p>
                </div>
              </div>
      ...
      <div className="group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-2xl overflow-hidden border border-white/10 hover:border-yellow-500/30 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-yellow-500/10">
        ...
        <div className="relative h-64 overflow-hidden">
          ...
          <div className="absolute top-4 left-4 flex gap-2">
            ...
            <span
              className={`px-3 py-1.5 backdrop-blur-sm text-xs font-bold rounded-full border ${
                item.status === "active"
        ...
        {/* Item Info */}
        <div className="p-6">
          <h3 className="text-xl font-bold text-white mb-3 line-clamp-1 group-hover:text-yellow-400 transition-colors capitalize">
            {item.title}
          </h3>
