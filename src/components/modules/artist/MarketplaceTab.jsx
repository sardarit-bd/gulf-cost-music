...
import { Edit2, Image as ImageIcon, Trash2, Upload, Video, X } from "lucide-react";
        ...
        return (
            <div className="text-center py-12">
                <div className="bg-gray-900 rounded-xl p-8 max-w-md mx-auto border border-gray-800">
                    ...
                    <h3 className="text-xl font-bold text-white mb-2">Marketplace Access Required</h3>
                    <p className="text-gray-400 mb-6">
                        Upgrade to <span className="text-yellow-400 font-semibold">Pro</span> plan to list your music gear, services,
                        or merchandise.
                    </p>
    ...
    return (
        <div className="space-y-8">
                ...
                <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-white mt-1">{existingItem ? 1 : 0}</p>
                        </div>
                ...
                <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-white mt-1">{listingPhotos.length}/5</p>
                        </div>
            ...
            <div className="flex border-b border-gray-700">
                <button
                    className={`px-4 py-3 font-medium text-sm ${activeSection === "create" ? "text-white border-b-2 border-yellow-500" : "text-gray-400 hover:text-white"
                        }`}
                    onClick={() => setActiveSection("create")}
                >
                    {isEditingListing ? "Edit Listing" : existingItem ? "Update Listing" : "Create New Listing"}
                </button>

                <button
                    className={`px-4 py-3 font-medium text-sm ${activeSection === "listings" ? "text-white border-b-2 border-yellow-500" : "text-gray-400 hover:text-white"
                        }`}
                ...
                <button
                    className={`px-4 py-3 font-medium text-sm ${activeSection === "guidelines" ? "text-white border-b-2 border-yellow-500" : "text-gray-400 hover:text-white"
                        }`}
            ...
            {activeSection === "create" && (
                <div className="space-y-8">
                    ...
                    <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                        <div className="flex items-center justify-between">
                            <div>
                                <h3 className="text-lg font-semibold text-white">Marketplace Dashboard</h3>
                                <p className="text-gray-400 text-sm mt-1">
                                    List your music gear, services, or merchandise. Verified sellers can manage one active listing.
                                </p>
                            </div>
                            <div className="flex gap-3">
                                <div className="bg-gray-800 px-4 py-2 rounded-lg border border-gray-700">
                                    <div className="text-xs text-gray-400">Your Plan</div>
                                    <div className="text-sm font-semibold text-white">{String(subscriptionPlan || "free").toUpperCase()}</div>
                                </div>
                                <div className="bg-gray-800 px-4 py-2 rounded-lg border border-gray-700">
                                    <div className="text-xs text-gray-400">Photos</div>
                                    <div className="text-sm font-semibold text-white">{listingPhotos.length}/5</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                />
                                <p className="mt-2 text-sm text-gray-400">Make it clear and attractive to buyers.</p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
                                    />
                                    <p className="mt-2 text-sm text-gray-400">Enter the price in US dollars.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select
                                        name="status"
                                        value={currentListing.status === "draft" ? "hidden" : currentListing.status}
                                        onChange={onListingChange}
                                    ...
                                    <p className="mt-2 text-sm text-gray-400">Set listing visibility.</p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
                                />
                                <p className="mt-2 text-sm text-gray-400">Where is your item/service located?</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-gray-400">Optional (UI only unless backend stores it).</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex justify-between mt-2 text-sm text-gray-500">
                                    ...
                                    <span>{String(currentListing.description || "").length}/2000</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                        <h3 className="text-lg font-semibold text-white mb-6">Media Upload</h3>
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <span className="text-sm text-gray-400">{listingPhotos.length}/5 uploaded</span>
                                </div>

                                <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
                                    {listingPhotos.map((photo, index) => (
                                        <div key={index} className="relative group">
                                            <img src={photo} alt={`Listing ${index + 1}`} className="w-full h-32 object-cover rounded-lg" />
                                            <button
                                                type="button"
                                    ...
                                    {listingPhotos.length < 5 && (
                                        <label className="cursor-pointer">
                                            ...
                                            <input
                                                ...
                                                accept="image/*"
                                                multiple
                                                onChange={(e) => onPhotoUpload(Array.from(e.target.files || []))}
                                                className="hidden"
                                            />
                                        </label>
                                    )}
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-4">
                                    <label className="block text-sm font-medium text-gray-300">Video (Optional)</label>
                                    <span className="text-sm text-gray-400">{listingVideos.length}/1 uploaded</span>
                                </div>
                                    ...
                                    {listingVideos.length < 1 && (
                                        <label className="cursor-pointer">
                                            ...
                                            <input
                                                type="file"
                                                accept="video/*"
                                                onChange={(e) => onVideoUpload(Array.from(e.target.files || []))}
                                                className="hidden"
                                            />
                                        </label>
                                    )}
                                ...
                                <p className="text-sm text-gray-400">Supports MP4, MOV (Max 50MB)</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end space-x-4">
                        ...
                        >
                            {existingItem ? "Update Marketplace Listing" : "Publish to Marketplace"}
                        </button>
                    </div>
                </div>
            )}
                ...
                <div className="space-y-6">
                    {loadingListings ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">No Listing Yet</h3>
                            <p className="text-gray-400 mb-6">Create your marketplace listing to start selling.</p>
                            <button
                                type="button"
                                onClick={() => setActiveSection("create")}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="bg-gray-900 rounded-xl overflow-hidden border border-gray-800">
                                ...
                                <div className="p-5">
                                    <h3 className="text-lg font-semibold text-white truncate">{existingItem.title}</h3>

                                    <div className="flex items-center justify-between mt-3">
                                        <span className="text-2xl font-bold text-yellow-500">${existingItem.price}</span>
                                        <span className="text-sm text-gray-400">{currentListing?.category || "artist"}</span>
                                    </div>

                                    <p className="text-gray-400 text-sm mt-3 line-clamp-2">{existingItem.description}</p>

                                    <div className="flex items-center justify-between mt-6">
                                        <div className="text-sm text-gray-500">{existingItem.location || "Location not specified"}</div>
            ...
            {activeSection === "guidelines" && (
                <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                    <h3 className="text-lg font-semibold text-white mb-6">Upload Guidelines</h3>

                    <div className="space-y-6">
                        {[
                            { t: "Photo Requirements", d: "Maximum 5 photos allowed per listing. Clear photos increase sales." },
                            { t: "Photo Quality", d: "Use natural lighting. Show multiple angles and any defects clearly." },
                            { t: "Video Guidelines", d: "Optional video under 2 minutes. Showcase key features or sound check." },
                            { t: "Listing Details", d: "Include condition, specs, what’s included, delivery method, and contact note." },
                            { t: "Pro Users Only", d: "Only Pro users can use marketplace features. Upgrade to start selling." },
                        ].map((x, i) => (
