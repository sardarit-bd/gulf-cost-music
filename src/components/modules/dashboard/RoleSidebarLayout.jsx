...
export default function RoleSidebarLayout({ role, children }) {
    ...
    return (
        <div className="flex min-h-screen bg-gray-50">
            ...
            <aside className={`hidden lg:flex fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-blue-600 to-blue-700 rounded-3xl m-2 p-6 flex-col text-white shadow-2xl z-20`}>
                {/* Logo Section */}
                <div className="mb-8">
                    <h1 className="text-2xl font-bold tracking-wide">Gulf Coast</h1>
                    <p className="text-sm text-blue-100 mt-1">{role.charAt(0).toUpperCase() + role.slice(1)} Dashboard</p>
                </div>
                    ...
                    {enhancedMenu.map((item) => {
                        ...
                        return (
                            <Link
                                ...
                                className={`w-full flex items-center gap-4 px-4 py-3 rounded-2xl transition-all duration-200 font-medium ${active
            ...
            {/* Main Content Area */}
            <div className={`flex-1 flex flex-col transition-all duration-300 ${isMobile ? 'ml-0' : 'lg:ml-64'}`}>
                {/* Top Header Bar */}
                            ...
                            <div className="relative" ref={userDropdownRef}>
                                ...
                                >
                                    ...
                                    <div className="hidden sm:block text-left">
                                        <p className="text-sm font-medium truncate max-w-[120px]">{getUserName()}</p>
                                        <p className="text-xs text-gray-500 capitalize truncate max-w-[120px]">{role}</p>
                                    </div>
