            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div>
                  ...
                  <div className="mt-1">
                    <span
                      className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getGenreColor(artist.genre)}`}
                    >
                      <Music className="w-4 h-4 mr-1" />
                      {capitalize(artist.genre) || "Not specified"}
                    </span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1 flex items-center">
                    ...
                    {capitalize(artist.city) || "Not specified"}
                  </p>
                </div>
            ...
            <div className="flex gap-2">
              {artist.user?.subscriptionPlan === "free" ? (
                <button
                  ...
                  className="px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition-colors text-sm font-medium flex items-center gap-2 cursor-pointer"
                >
