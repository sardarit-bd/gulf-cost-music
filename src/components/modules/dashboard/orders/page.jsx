...
export default function UniversalOrderTracking() {
    ...
    const statuses = [
        { value: "pending", label: "Pending", icon: Clock, color: "text-amber-600", bgColor: "bg-amber-50", borderColor: "border-amber-200" },
        { value: "confirmed", label: "Confirmed", icon: CheckCircle, color: "text-blue-600", bgColor: "bg-blue-50", borderColor: "border-blue-200" },
        { value: "processing", label: "Processing", icon: RefreshCw, color: "text-indigo-600", bgColor: "bg-indigo-50", borderColor: "border-indigo-200" },
        { value: "ready-for-pickup", label: "Ready for Pickup", icon: Package, color: "text-purple-600", bgColor: "bg-purple-50", borderColor: "border-purple-200" },
        { value: "shipped", label: "Shipped", icon: Truck, color: "text-cyan-600", bgColor: "bg-cyan-50", borderColor: "border-cyan-200" },
        { value: "delivered", label: "Delivered", icon: CheckCircle, color: "text-emerald-600", bgColor: "bg-emerald-50", borderColor: "border-emerald-200" },
        { value: "cancelled", label: "Cancelled", icon: XCircle, color: "text-rose-600", bgColor: "bg-rose-50", borderColor: "border-rose-200" },
    ];
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    {userRole === 'admin' && order.buyer && (
                                                        <p className="text-gray-600 text-sm mt-1 flex items-center gap-2">
                                                            Customer: <span className="font-medium">{order.buyer.username}</span>
                                            ...
                                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                                                <span className={`px-4 py-2 rounded-full text-sm font-medium ${order.paymentStatus === 'paid'
                                        ...
                                        <div className="flex gap-6 items-start mb-6 p-4 bg-gray-50 rounded-xl">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-gray-600 mb-3">{order.quantity} × ${order.merch?.price}</p>
                                                ...
                                                <div className="flex items-center justify-between mt-4">
                                                    ...
                                                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${currentStatus.bgColor} ${currentStatus.color}`}>
                                                        {currentStatus.label}
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="relative mt-8">
                                            <div className="flex justify-between mb-4">
                                                {statuses.slice(0, 6).map((item, index) => {
                                                    ...
                                                    return (
                                                        <div key={item.value} className="flex flex-col items-center w-full text-center relative z-10">
                                                            <div
                                                            ...
                                                            <p className={`text-xs mt-3 font-medium transition-colors ${isActive ? "text-gray-900" : "text-gray-400"
                                                                }`}>
                                                                {item.label}
                                                            </p>
                                                        </div>
                                        ...
                                        {order.deliveryStatus === "cancelled" && (
                                            <div className="mt-6 p-4 rounded-xl bg-rose-50 border border-rose-200 flex gap-3 items-center animate-pulse">
                                                ...
                                                <div>
                                                    <p className="text-rose-800 font-semibold">Order Cancelled</p>
