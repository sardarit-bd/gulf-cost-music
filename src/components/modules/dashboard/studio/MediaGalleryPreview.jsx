...
export default function MediaGalleryPreview({ photos = [], audioFile = null }) {
  ...
  return (
    <>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex bg-gray-100 rounded-lg p-1">
                <button
                  ...
                  className={`cursor-pointer p-2 rounded ${viewMode === "grid" ? "bg-white shadow" : "text-gray-600"}`}
                >
                  <Grid className="w-4 h-4 text-yellow-400" />
                </button>
                <button
                  onClick={() => setViewMode("list")}
                  className={`cursor-pointer p-2 rounded ${viewMode === "list" ? "bg-white shadow" : "text-gray-600"}`}
                >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {photoCount}/{maxPhotos} uploaded • {remainingPhotos}{" "}
                    remaining
                  </p>
                </div>
              </div>
      ...
      {selectedImage && (
        <FullscreenImage image={selectedImage} onClose={closeFullscreen} />
      )}
    </>
  );
}
