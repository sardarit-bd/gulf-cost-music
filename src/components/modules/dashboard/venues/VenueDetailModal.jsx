        ...
        <div className="p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              <div
                ...
                style={{
                  ...
                  background: hasColor
                    ? `linear-gradient(135deg, ${venue.colorCode}99, ${venue.colorCode})`
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p
                    className={`text-sm ${currentPlan === "pro" ? "text-yellow-700" : "text-gray-700"}`}
                  >
                    Current Plan:{" "}
                ...
                <div className="flex gap-2">
                  {currentPlan === "free" ? (
                    <button
                      ...
                      className="px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 text-sm font-medium cursor-pointer"
                    >
                      Upgrade to Pro
                    </button>
                  ) : (
                    <button
                      ...
                      className="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 text-sm font-medium cursor-pointer"
                    >
                      Downgrade to Free
                    </button>
                  )}
            ...
            {isVerified ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-green-600">
                      #{venue.verifiedOrder} in {venue.city}
                    </p>
                  </div>
                  <div>
                    <span className="text-green-700 font-medium">
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p className="text-yellow-700 text-sm mb-3">
                  This venue is not yet verified. Verify to assign a unique
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 mt-1 flex items-center">
                    ...
                    {venue.city
                      ? venue.city.charAt(0).toUpperCase() + venue.city.slice(1)
                      : "Not specified"}
                  </p>
                  {venue.address && (
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <span
                      className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getCapacityColor(venue.seatingCapacity)}`}
                    >
          ...
          <div className="flex justify-end space-x-3 mt-6 pt-4 border-t">
            ...
            <button
              ...
              className="px-4 py-2 bg-yellow-500 text-white rounded-lg bg-primary/80 transition-colors text-sm font-medium cursor-pointer"
            >
              Edit Venue
            </button>
            <button
              onClick={onClose}
              className="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition-colors text-sm font-medium cursor-pointer"
            >
              Close
            </button>
          </div>
