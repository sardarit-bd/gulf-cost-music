    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-300 p-4 sm:p-6 mb-4 sm:mb-6">
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-end">
                ...
                <button
                    onClick={onApply}
                    className="w-full sm:w-auto px-4 sm:px-6 py-2 bg-[var(--primary)] text-black rounded-lg hover:bg-primary/80 font-medium transition-colors flex items-center space-x-2 justify-center text-sm sm:text-base"
                >
