            ...
            <div className="px-4 py-3 border-b border-gray-100 bg-gray-50">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            onClick={onSearch}
                            className="px-3 py-1.5 bg-purple-600 text-white rounded-lg hover:bg-purple-700 text-sm font-medium flex items-center gap-1 transition-colors cursor-pointer"
                        >
                            ...
                            <tr>
                                <td colSpan="6" className="px-6 py-12 text-center">
                                    <div className="text-gray-500">
                                        ...
                                        <p className="text-sm">
                                            {hasActiveFilters ? `No results found for "${activeSearchTerm}"` : "No products have been created yet"}
                                        </p>
                                        {hasActiveFilters && (
                                            <button
                                                onClick={onClearSearch}
...
const ProductRow = ({ item, onViewDetails, onEdit, onDelete, onToggleStatus, actionLoading }) => {
    return (
        <tr className="hover:bg-gray-50 transition-colors">
            ...
            <td className="px-6 py-4 whitespace-nowrap">
                <button
                    ...
                    className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium transition cursor-pointer ${item.isActive
